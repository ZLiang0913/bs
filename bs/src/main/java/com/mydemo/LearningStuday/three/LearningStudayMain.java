...
public class LearningStudayMain {
	...
	public static void main(String[] args) throws Exception {
		String[] path = {"hdfs://192.168.203.111:9000/sqoop/result/LearningStuday/output2/part-r-00000",
        "hdfs://192.168.203.111:9000/sqoop/result/LearningStuday/output3"};
		...
		job.setReducerClass(LearningStudayReducer.class);
